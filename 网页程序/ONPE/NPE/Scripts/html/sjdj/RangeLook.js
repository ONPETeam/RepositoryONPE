...
//var branch_id = "13"; //parent.userinfo.branch_id
var userName = parent.userinfo.user_name; //
var branch_id = parent.userinfo.branch_id; //
$(document).ready(function () {
    $('#dg').datagrid({
        url: '../../ashx/Mobile/dxj/PlanShow.ashx?type=para2',
        queryParams: {
            branchID: branch_id,
...
function CreatePlan() {
    $.ajax({
        url: '../../ashx/Mobile/dxj/PlanMethod.ashx?type=para2',
        type: 'post',
        data: {
            'branchID': branch_id
        },
        ...
        success: function (data) {
            if (data && data.toString() == "0") {
                showMsg("操作提示", "计划生成成功！", "info");
            } else {
                showMsg("操作提示", "计划生成失败！", "info");
            }
        },
