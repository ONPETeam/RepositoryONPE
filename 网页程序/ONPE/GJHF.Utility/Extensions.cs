...
namespace GJHF.Utility
{
    public static class Extensions
    {
        ...
        {
            return GJHF.Utility.Encryption.Encrypt(str);
        }
        /// <summary>
        /// AES解密字符串
        /// </summary>
        ...
        {
            return GJHF.Utility.Encryption.Decrypt(str);
        }
        ...
        {
            return GJHF.Utility.EncryptionDes.Encrypt(str);
        }
        /// <summary>
        /// DES解密字符串
        /// </summary>
        ...
        {
            return GJHF.Utility.EncryptionDes.Decrypt(str);
        }
        ...
        {
            return date.ToDateTime().ToString(GJHF.Utility.Config.DateFormat);
        }

        public static string ToDateTimeString(this string dateTime)
        {
            return dateTime.ToDateTime().ToString(GJHF.Utility.Config.DateTimeFormat);
        }

        public static string ToDateTimeStringS(this string dateTime)
        {
            return dateTime.ToDateTime().ToString(GJHF.Utility.Config.DateTimeFormatS);
        }

        public static string ToDateString(this DateTime date)
        {
            return date.ToString(GJHF.Utility.Config.DateFormat);
        }

        public static string ToDateTimeString(this DateTime dateTime)
        {
            return dateTime.ToString(GJHF.Utility.Config.DateTimeFormat);
        }

        public static string ToDateTimeStringS(this DateTime dateTime)
        {
            return dateTime.ToString(GJHF.Utility.Config.DateTimeFormatS);
        }
    }
}
