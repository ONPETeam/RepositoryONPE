    ...
    e.fn.smartZoom=function(t){
        ...
        function p(e){
            ...
            if(s==1&&!t.touch.touchPinch&&t.settings.touchMoveEnabled==true){
                ...
                t.touch.touchPinch=true;var a=r[1];
